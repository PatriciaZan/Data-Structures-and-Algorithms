// 1. Create new node
// 2. Where are you going to place the new node?
// 3. Find the prev node 
// 4. Point the new node point to the next node
// 5. Point the prev node pointer to the new node
